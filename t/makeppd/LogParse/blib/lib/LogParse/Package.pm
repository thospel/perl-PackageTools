...
# $HeadURL: http://subversion.bmsg.nl/repos/kpn/trunk/src/perl-modules/LogParse/lib/LogParse/Package.pm $
# $Id: Package.pm 3116 2008-07-14 09:00:00Z hospelt $

# START HISTORY
# autogenerated by release_pm
use vars qw($VERSION $release_time %history);
$VERSION = "1.005";
$release_time = 1266762868;
%history = (
  'Changes' => {
    '1.000' => '1.000',
    '1.001' => '1.001',
